    ...
    data.forEach(r => {
      ...
      tr.innerHTML = `
        ...
        <td class="status-cell">
          <span class = "status ${r.status.advisor.toLowerCase()}">${r.status.advisor} </td>
        <td class="status-cell"> <span class = "status ${r.status.hod.toLowerCase()}">${r.status.hod} </td>
         <td><span class = "status ${r.status.warden.toLowerCase()}">${r.status.warden}
        </td>
        <td class = "status-cell">
